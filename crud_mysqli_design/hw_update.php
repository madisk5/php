...
if(isset($_POST['submit'])) {
    ...
    if($database->dbQuery($sql)) {
        ...
        // Suuname tagasi õigele lehele
        $page = isset($_POST['page']) ? $_POST['page'] : 'kodutoo.php';
        $pg = isset($_GET['pg']) ? $_GET['pg'] : 1; // Hetkel vaadatava lehekülje number
        header("Location: $page?pg=$pg");
        exit;
    } else {
        $success = false;
    }
