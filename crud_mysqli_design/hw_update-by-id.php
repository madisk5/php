...
// Vaikimisi leht, kuhu suunatakse pärast muudatuste salvestamist
$redirectPage = 'kodutoo.php';
?>
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <form action="hw_update.php" method="post">
...
if(isset($_POST['submit'])) {
    // Suuname kasutaja tagasi määratud lehele
